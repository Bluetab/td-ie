defmodule TdIeWeb.Hypermedia.HypermediaControllerHelper do
  @moduledoc false

  alias Gettext.Interpolation
  alias TdIeWeb.Hypermedia.HypermediaCollection
  alias TdIeWeb.Hypermedia.Link
  alias TdIeWeb.Router
  import Canada.Can
